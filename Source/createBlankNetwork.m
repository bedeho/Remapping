...
function C_N = CreateBlankNetwork(outputfile, R_preferences, C_N, R_N, S_N, R_to_R_pos_sigma, R_to_R_neg_sigma, S_to_C_connectivity, V_to_C_connectivity, C_to_R_connectivity)
